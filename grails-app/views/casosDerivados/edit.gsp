...
<html>
    ...
    <body>
        ...
        <div id="edit-casosDerivados" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.casosDerivados}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.casosDerivados}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.casosDerivados}" method="PUT">
                <g:hiddenField name="version" value="${this.casosDerivados?.version}" />
                <fieldset class="form">
                    <f:all bean="casosDerivados"/>
                </fieldset>
