...
<html>
    ...
    <body>
        ...
        <div id="edit-depEstado" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.depEstado}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.depEstado}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.depEstado}" method="PUT">
                <g:hiddenField name="version" value="${this.depEstado?.version}" />
                <fieldset class="form">
                    <f:all bean="depEstado"/>
                </fieldset>
