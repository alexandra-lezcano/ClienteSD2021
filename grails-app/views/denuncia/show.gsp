...
<html>
    ...
    <body>
        ...
        <div id="show-denuncia" class="content scaffold-show" role="main">
            ...
            <f:display bean="denuncia" />
            <g:form resource="${this.denuncia}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.denuncia}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
